...
사용법 (프로젝트 루트에서 실행):
    python -m src.recognition.pipeline --image "옷사진.jpg" --model src/recognition/models/best.pt
    python -m src.recognition.pipeline --image_dir "내옷들/" --model src/recognition/models/best.pt --output results.json
"""
